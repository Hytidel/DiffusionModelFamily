...
@torch.no_grad()
def sample_flux_1_dev_implement(
    cfg: DictConfig
):
    # ---------= [Global Variables] =---------
    ...
    max_sequence_length = get_true_value(cfg["task"]["task"]["max_sequence_length"])
    ...
    logger(f"    max_sequence_length: {max_sequence_length}")
    ...
    # `sample_flux_1_dev_implement()` done
    pass

def sample_flux_1_dev(
    cfg: DictConfig
):
    sample_flux_1_dev_implement(cfg)
